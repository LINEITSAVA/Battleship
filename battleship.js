...
var controller = {
    ...
    processGuess: function(guess) {
        ...
        //var finalClick = document.getElementById("board");
        if (location) {
            this.guesses++;
            var hit = model.fire(location);
            if (hit && model.shipsSunk === model.numShips) {

                view.displayMessage("You sank all my battleships, in " + this.guesses + " guesses!" + " Press F5 to restart!");
